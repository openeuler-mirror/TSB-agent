...
TEST(OpMigrateTest, ParseArgvValidArgumentsTest) {
  ...
  const char *argv[] = {"op_migrate", "test_doamin",
                        "qemu+ssh://destination.example.com/system"};
  int argc = 3;
...
TEST(OpMigrateTest, ParseArgvComplexArgumentsTest) {
  ...
  const char *argv[] = {"op_migrate", "complex-domain-name-123",
                        "qemu+ssh://user@host:22/system?param=value"};
  int argc = 3;
...
TEST(OpMigrateTest, ParseArgvFlagCombinationTest) {
  ...
  const char *argv[] = {"op_migrate", "test-dimain_123",
                        "qemu+ssh://user@host.example.com:22/system"};
  int argc = 3;
