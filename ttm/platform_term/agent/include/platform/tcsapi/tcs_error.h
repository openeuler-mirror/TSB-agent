...
enum{
	...
	TSS_ERR_ttm_sm3_init,   		/* sm3 init error */
	TSS_ERR_ttm_sm3_update,		/* sm3 update error */
  ...
  TSS_ERR_INVALID_ACTION, /*Invalid ACTION*/
  TSS_ERR_INVALID_POLICY, /*Invalid POLICY */
  TSS_ERR_TPCM_ID, /*tpcm id err*/
