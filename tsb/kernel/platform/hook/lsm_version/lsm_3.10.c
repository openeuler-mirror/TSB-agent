...
static int lsm_httc_inode_link(struct dentry *old_dentry, struct inode *dir,
...
static int lsm_httc_inode_mkdir(struct inode *dir, struct dentry *dentry, umode_t mode)
{
...
static void lsm_init_prepare(void)
{
	...
	lsm_httc_ops.mmap_file = lsm_httc_mmap_file;
	lsm_httc_ops.kernel_module_from_file = lsm_httc_kernel_module_from_file;
	lsm_httc_ops.file_open = lsm_httc_file_open;
