...
void vli_square(u8 *result, u8 *left)
{
	...
	for (k = 0; k < ECC_NUMWORD*2 - 1; ++k) {
		u32 min = (k < ECC_NUMWORD ? 0 : (k + 1) - ECC_NUMWORD);
...
static void ecc_point_double_jacobian(u8 *X1, u8 *Y1, u8 *Z1)
{
	u8 t4[ECC_NUMWORD];
	u8 t5[ECC_NUMWORD];
...
static void apply_z(u8 *X1, u8 *Y1, u8 *Z)
{
	u8 t1[ECC_NUMWORD];
...
static void XYcZ_initial_double(u8 *X1, u8 *Y1, u8 *X2, u8 *Y2, u8 *initialZ)
{
	u8 z[ECC_NUMWORD];
...
static void XYcZ_add(u8 *X1, u8 *Y1, u8 *X2, u8 *Y2)
{
	u8 t5[ECC_NUMWORD];
...
static void XYcZ_addC(u8 *X1, u8 *Y1, u8 *X2, u8 *Y2)
{
	u8 t5[ECC_NUMWORD];
	u8 t6[ECC_NUMWORD];
	u8 t7[ECC_NUMWORD];
