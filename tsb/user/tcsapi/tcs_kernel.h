...
struct kernel_section_info{
	...
	//uint64_t data_address;/** Physical Address */
	//uint32_t data_length;  /*度量内�?�长�?*/
	uint8_t  hash_data[KERNEL_SECTION_HASH];/*度量结果�*/
};
 ...
 * 	��ȡLicense״̬
 */
int tcsk_get_license_status(int *status,int *left, const struct license_arg *param);//proc����
 ...
 * 	获取License状态
 */
int tcsk_get_license_status(int *status,int *left);//proc导出
/** 获取License信息 */
