...
global_policy_test ()
{
	...
	./user/test/tcs/auth -n $GLOBAL_POLICY_UID -c 1 -d $GLOBAL_POLICY_PUBKEY -o 2 -k $ROOT_PRIVKEY$ROOT_PUBKEY; exec_check "tcs_remove_admin_role"
}
...
process_id_role_test ()
{
	...
	./user/test/tcs/process -o 1; exec_check "tcs_get_process_ids"
	./user/test/tcs/auth -n $PROCESS_UID -c 1 -d $PROCESS_PUBKEY -o 2 -k $ROOT_PRIVKEY$ROOT_PUBKEY; exec_check "tcs_remove_admin_role"
}
...
file_protect_test ()
{
	...
	echo "设置文件访问控制策略"
	./user/test/tcs/update_file_protect_policy -a 0 -m 1 -T 0 -P /usr/bin/one -t 0 -p /usr/bin/ls -u $FILE_PROTECT_UID -k $FILE_PROTECT_PRIVKEY$FILE_PROTECT_PUBKEY; exec_check "tcs_update_file_protect_policy set"
	
	echo "获取文件访问控制策略"
	./user/test/tcs/get_file_protect_policy; exec_check "tcs_get_file_protect_policy"
	
	echo "增加文件访问控制策略"
	./user/test/tcs/update_file_protect_policy -a 1 -m 2 -T 0 -P /usr/bin/two -t 0 -p /usr/bin/cat -u $FILE_PROTECT_UID -k $FILE_PROTECT_PRIVKEY$FILE_PROTECT_PUBKEY; exec_check "tcs_update_file_protect_policy add"
	echo "获取文件访问控制策略"
	./user/test/tcs/get_file_protect_policy; exec_check "tcs_get_file_protect_policy"
	
	echo "增加文件访问控制策略"
	./user/test/tcs/update_file_protect_policy -a 1 -m 2 -T 0 -P /usr/bin/two -t 0 -p /usr/bin/cat -u $FILE_PROTECT_UID -k $FILE_PROTECT_PRIVKEY$FILE_PROTECT_PUBKEY; right_check "tcs_update_file_protect_policy add"
	
	echo "删除文件访问控制策略"
	./user/test/tcs/update_file_protect_policy -a 2 -m 1 -T 0 -P /usr/bin/one -t 0 -p /usr/bin/ls -u $FILE_PROTECT_UID -k $FILE_PROTECT_PRIVKEY$FILE_PROTECT_PUBKEY; exec_check "tcs_update_file_protect_policy delete"
	echo "获取文件访问控制策略"
	./user/test/tcs/get_file_protect_policy; exec_check "tcs_get_file_protect_policy"	
	
	echo "删除文件访问控制策略"
	./user/test/tcs/update_file_protect_policy -a 2 -m 1 -T 0 -P /usr/bin/three -t 0 -p /usr/bin/ls -u $FILE_PROTECT_UID -k $FILE_PROTECT_PRIVKEY$FILE_PROTECT_PUBKEY; exec_check "tcs_update_file_protect_policy delete"
	echo "获取文件访问控制策略"
	./user/test/tcs/get_file_protect_policy; exec_check "tcs_get_file_protect_policy"
	./user/test/tcs/auth -n $FILE_PROTECT_UID -c 1 -d $FILE_PROTECT_PUBKEY -o 2 -k $ROOT_PRIVKEY$ROOT_PUBKEY; exec_check "tcs_remove_admin_role"	
}
cdrom_protect_test ()
{
	echo ">>> cdrom_protect_test <<<"
	./user/test/tcs/tcs_init $OWNER_PWD
	./user/test/tcs/generate_tpcm_pik $OWNER_PWD; exec_check "generate_tpcm_pik"
	...
	echo "设置设备外设策略"
	./user/test/tcs/update_dev_protect_policy -a 0  -T 0  -c 1  -u $FILE_PROTECT_UID -k $FILE_PROTECT_PRIVKEY$FILE_PROTECT_PUBKEY; exec_check "tcs_update_dev_protect_policy set"
	
	echo "获取外设控制策略"
	./user/test/tcs/get_dev_protect_policy; exec_check "tcs_get_dev_protect_policy"
	
	echo "增加外设访问控制策略"
	./user/test/tcs/update_dev_protect_policy -a 1  -T 1  -c 1  -u $FILE_PROTECT_UID -k $FILE_PROTECT_PRIVKEY$FILE_PROTECT_PUBKEY; exec_check "tcs_update_dev_protect_policy add"
	echo "获取外设访问控制策略"
	./user/test/tcs/get_dev_protect_policy; exec_check "tcs_get_dev_protect_policy"
	

	echo "删除外设访问控制策略"
	./user/test/tcs/update_dev_protect_policy -a 2  -T 0  -c 1  -u $FILE_PROTECT_UID -k $FILE_PROTECT_PRIVKEY$FILE_PROTECT_PUBKEY; exec_check "tcs_update_dev_protect_policy delete"
	echo "获取外设访问控制策略"
	./user/test/tcs/get_dev_protect_policy; exec_check "tcs_get_dev_protect_policy"	
...
udisk_protect_test ()
{
	...
	echo "设置外设设备udisk策略"
	./user/test/tcs/update_udisk_protect_policy -a 0  -T 1  -c 1 -g "guidtest" -u $FILE_PROTECT_UID -k $FILE_PROTECT_PRIVKEY$FILE_PROTECT_PUBKEY; exec_check "tcs_update_udisk_protect_policy set"
	
	echo "获取外设udisk控制策略"
	./user/test/tcs/get_udisk_protect_policy; exec_check "tcs_get_udisk_protect_policy"
	
	echo "增加外设udisk访问控制策略"
	./user/test/tcs/update_udisk_protect_policy -a 1  -T 1  -c 1  -g "guidadd" -u $FILE_PROTECT_UID -k $FILE_PROTECT_PRIVKEY$FILE_PROTECT_PUBKEY; exec_check "tcs_update_udisk_protect_policy add"
	echo "获取外设访问控制策略"
	./user/test/tcs/get_udisk_protect_policy; exec_check "tcs_get_udisk_protect_policy"
	

	echo "删除外设udisk访问控制策略"
	./user/test/tcs/update_udisk_protect_policy -a 2  -T 0  -c 1 -g "guidtest" -u $FILE_PROTECT_UID -k $FILE_PROTECT_PRIVKEY$FILE_PROTECT_PUBKEY; exec_check "tcs_update_udisk_protect_policy delete"
	echo "获取外设访问控制策略"
	./user/test/tcs/get_udisk_protect_policy; exec_check "tcs_get_udisk_protect_policy"	
...
network_control_test ()
{
	...
	echo "设置外设设备network策略"
	./user/test/tcs/update_network_control_policy -w 0 -d 1 -f 100  -t 200 -s 0x00000002  -a 0  -u $FILE_PROTECT_UID -k $FILE_PROTECT_PRIVKEY$FILE_PROTECT_PUBKEY; exec_check "tcs_update_network_control_policy set"
    
	echo "获取外设network控制策略"
	./user/test/tcs/get_network_control_policy; exec_check "get_network_control_policy"
	
	echo "增加外设network访问控制策略"
	./user/test/tcs/update_network_control_policy -w 0 -d 1 -f 100  -t 300 -s 0x00000001  -a 1 -u $FILE_PROTECT_UID -k $FILE_PROTECT_PRIVKEY$FILE_PROTECT_PUBKEY; exec_check "tcs_update_network_control_policy add"
	echo "获取外设访问控制策略"
	./user/test/tcs/get_network_control_policy; exec_check "get_network_control_policy"
	
	echo "增加相同参数外设network访问控制策略"
	./user/test/tcs/update_network_control_policy -w 0 -d 1 -f 100  -t 300 -s 0x00000001  -a 1 -u $FILE_PROTECT_UID -k $FILE_PROTECT_PRIVKEY$FILE_PROTECT_PUBKEY; right_check "tcs_update_network_control_policy add"
	echo "获取外设访问控制策略"
	./user/test/tcs/get_network_control_policy; exec_check "get_network_control_policy"
	

	echo "删除外设network访问控制策略"
	./user/test/tcs/update_network_control_policy -w 0 -d 1 -f 100  -t 200 -s 0x00000002  -a 2 -u $FILE_PROTECT_UID -k $FILE_PROTECT_PRIVKEY$FILE_PROTECT_PUBKEY; exec_check "tcs_update_network_control_policy delete"
	echo "获取外设访问控制策略"
	./user/test/tcs/get_network_control_policy; exec_check "get_network_control_policy"	
...
Usage()
{
	...
	echo "  15    :  key_test"
	echo "  55    :  key_test(no keystroe nv)"
	echo "  16    :  store_test"
	echo "  17    :  tnc_test"
	...
	echo "  23    :  sm234_test"
	echo "  24    :  file_protect_test"	
	echo "  25    :  dev_protect_test"
	echo "  26    :  udisk_protect_test"
	echo "  27    :  network_control_test"
	echo "  28    :  set_tpcm_shell_auth_test"
	echo "  29    :  linked_switch_status_test"
