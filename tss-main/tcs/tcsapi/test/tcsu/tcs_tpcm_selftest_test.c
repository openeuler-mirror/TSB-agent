/**
****************************************************************************************
 * @FilePath: tcs_tpcm_selftest_test.c
 * @Author: wll
 * @Date: 2023-06-26 15:18:12
 * @LastEditors: 
 * @LastEditTime: 2023-06-26 15:19:27
...
{
	printf ("\n"
			" Usage: ./tcs_tpcm_selftest_test \n"
			"    eg. ./tcs_tpcm_selftest_test\n"
			"\n");
}
