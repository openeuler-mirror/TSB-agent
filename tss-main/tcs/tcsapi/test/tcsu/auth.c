...
{
	printf ("\n"
			" Usage: ./auth -n <name> -c <cert_type> -d <cert_data> -o <operation> -k <key>\n"
			"		 -n <name>      - The name of cert\n"
			"		 -c <cert_type> - The auth_type (default)1:SM2 2:HMAC 3:X501_SM2\n"
			"		 -d <cert_data> - The cert data\n"
			"		 -o <operation> - (default)0:tcs_set_admin_cert\n"
			"                                  1:tcs_grant_admin_role\n"
			"                                  2:tcs_remove_admin_role\n"
			"                                  3:tcs_get_admin_list\n"
			"		 -k <key>       - The privkey string + pubkey string\n"			
			"	 eg. ./auth -n root -c 1 -d 09AA298AE0D2FF1A541C4CB02AF80D0C118F427A2623C5DB2D08A151D873CA99FD76A2F4BD9FA0D6FDB52BDE2124DB29B2B170E570A6E1BEE41138608F04750A -o 0\n"
			"	 eg. ./auth -n root -c 1 -d 09AA298AE0D2FF1A541C4CB02AF80D0C118F427A2623C5DB2D08A151D873CA99FD76A2F4BD9FA0D6FDB52BDE2124DB29B2B170E570A6E1BEE41138608F04750A -o 1 -k 60FFA139866D596A8E107C76F3B92BB32422ED302701FA6865B86CC82DAAFC2C09AA298AE0D2FF1A541C4CB02AF80D0C118F427A2623C5DB2D08A151D873CA99FD76A2F4BD9FA0D6FDB52BDE2124DB29B2B170E570A6E1BEE41138608F04750A\n\n");
}
...
//				httc_util_dump_hex ("pubkey", pubkey , TPCM_PUBKEY_STR_LEN/2);
	...
	if(opt == 0){
		...
		ret = tcs_set_admin_cert(update,cert_type, signlen,sign);		
		if(ret){
		...
		ret = tcs_grant_admin_role(update, cert_type,signlen,sign);
		if(ret){
		...
		ret = tcs_remove_admin_role(update, cert_type,signlen,sign);
		if(ret){
