...
int tcf_get_file_integrity_valid_number (uint32_t *num);//proc 导出
/*
 * 	获取基准库存储条数
 */
int tcf_get_file_integrity_total_number (uint32_t *num);//proc 导出

/*
 *	获取基准库可增量修改限制
 */
int tcf_get_file_integrity_modify_number_limit (uint32_t *num);//proc 导出
